...
class nodepool (
  ...
  if $image_log_document_root == $upload_log_document_root and
    (($enable_image_log_via_http and not $enable_upload_log_via_http) or
    (not $enable_image_log_via_http and $enable_upload_log_via_http)) {
